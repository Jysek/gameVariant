"""
Boss -- animazione GIF, 4 cannoni, scaling progressivo.
...
Effetto hit: pulsazione sottile dello sprite (nessun overlay colorato).
"""
import random
import pygame
...
class Boss:
    """Boss con animazione GIF, 4 cannoni e barra vita.
    ...
    def get_rect(self) -> pygame.Rect:
        ...
        estremita' trasparenti dell'animazione GIF.
        """
        return pygame.Rect(
            self.x + 15,
            self.y + 10,
